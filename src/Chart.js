...
class CandleStickChartWithEquidistantChannel extends React.Component {
  constructor(props) {
    ...
    this.stopLossLevel = 3015; // Your stop loss level
    this.takeProfitLevel = 3022; // Your take profit level
      ...
      <div>
        <button
          ...
          onClick={() => {
            ...
            //   // Callback function invoked after state has been updated
            //   console.log(this.state.enable); // Now this will log the updated value
            // });
          }}
        >
          Delete
        ...
        <button
          style={{ margin: "8px" }}
          disabled={channels_1.length || this.state.enableInteractiveObject}
          onClick={() => {
        ...
        <button
          style={{ margin: "8px" }}
          disabled={!this.state.enableInteractiveObject}
          onClick={() => {
        ...
        >
          ...
          >
            ...
            />
            <LineSeries
              yAccessor={() => this.stopLossLevel}
              stroke="red"
              strokeDasharray="LongDash"
            />

            <LineSeries
              yAccessor={() => this.takeProfitLevel}
              stroke="green"
              strokeDasharray="LongDash"
            />
